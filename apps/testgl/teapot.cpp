...
const GLfloat teapotVertF[530*3] =
{
  2.1f, 3.6f, 0.0f,
  2.071f, 3.711f, 0.0f,
  2.105f, 3.748f, 0.0f,
...
const float teapotNormalF[530*3] =
{
...
GLfloat teapotVert  [numFaces * 9];
GLfloat teapotNormal[numFaces * 9];
...
initTeapotF()
{
  int ivIndex(0);
  int inIndex(0);
  int vidx0, vidx1, vidx2, nidx0, nidx1, nidx2;

  for(int face(0); face < numFaces; face++)
  {
    vidx0 = teapotFaceF[(face * 8) + 1],
    vidx1 = teapotFaceF[(face * 8) + 2],
    vidx2 = teapotFaceF[(face * 8) + 3],
    nidx0 = teapotFaceF[(face * 8) + 4],
    nidx1 = teapotFaceF[(face * 8) + 5],
    nidx2 = teapotFaceF[(face * 8) + 6];

    teapotVert  [ivIndex++] = teapotVertF[vidx0 * 3 + 0];
    teapotVert  [ivIndex++] = teapotVertF[vidx0 * 3 + 1];
    teapotVert  [ivIndex++] = teapotVertF[vidx0 * 3 + 2];
    teapotVert  [ivIndex++] = teapotVertF[vidx1 * 3 + 0];
    teapotVert  [ivIndex++] = teapotVertF[vidx1 * 3 + 1];
    teapotVert  [ivIndex++] = teapotVertF[vidx1 * 3 + 2];
    teapotVert  [ivIndex++] = teapotVertF[vidx2 * 3 + 0];
    teapotVert  [ivIndex++] = teapotVertF[vidx2 * 3 + 1];
    teapotVert  [ivIndex++] = teapotVertF[vidx2 * 3 + 2];

    teapotNormal[inIndex++] = -teapotNormalF[nidx0 * 3 + 0];
    teapotNormal[inIndex++] = -teapotNormalF[nidx0 * 3 + 1];
    teapotNormal[inIndex++] = -teapotNormalF[nidx0 * 3 + 2];
    teapotNormal[inIndex++] = -teapotNormalF[nidx1 * 3 + 0];
    teapotNormal[inIndex++] = -teapotNormalF[nidx1 * 3 + 1];
    teapotNormal[inIndex++] = -teapotNormalF[nidx1 * 3 + 2];
    teapotNormal[inIndex++] = -teapotNormalF[nidx2 * 3 + 0];
    teapotNormal[inIndex++] = -teapotNormalF[nidx2 * 3 + 1];
    teapotNormal[inIndex++] = -teapotNormalF[nidx2 * 3 + 2];
  }
}
...
drawTeapotF()
{
  glVertexPointer(3, GL_FLOAT, 0, teapotVert);
  glNormalPointer(   GL_FLOAT, 0, teapotNormal);

...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2, type3 arg3) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2, type3 arg3, type4 arg4) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2, type3 arg3, type4 arg4, type5 arg5) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2, type3 arg3, type4 arg4, type5 arg5, type6 arg6) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI void \
APIENTRY name(type1 arg1, type2 arg2, type3 arg3, type4 arg4, type5 arg5, type6 arg6, type7 arg7, type8 arg8, type9 arg9) \
{ \
  GLES_GET_CONTEXT(); \
...
GLAPI GLenum APIENTRY glGetError (void){return pCurrentContext->glGetError();}
...
#define VERTEX_WRAPPERS(ch,type,def3,def4) \
  GLAPI void APIENTRY glVertex2##ch     (type x, type y)        {glVertex4##ch(x,    y,    def3, def4);} \
  GLAPI void APIENTRY glVertex3##ch     (type x, type y, type z){glVertex4##ch(x,    y,    z,    def4);} \
  GLAPI void APIENTRY glVertex2##ch##v  (const type * v)        {glVertex4##ch(v[0], v[1], def3, def4);} \
  GLAPI void APIENTRY glVertex3##ch##v  (const type * v)        {glVertex4##ch(v[0], v[1], v[2], def4);} \
  GLAPI void APIENTRY glVertex4##ch##v  (const type * v)        {glVertex4##ch(v[0], v[1], v[2], v[3]);}
#define NORMAL_WRAPPERS(ch,type) \
  GLAPI void APIENTRY glNormal3##ch##v  (const type * v){glNormal3##ch(v[0], v[1], v[2]);}
#define COLOR_WRAPPERS(ch,type,def4) \
  GLAPI void APIENTRY glColor3##ch      (type red, type green, type blue){glColor4##ch(red,  green, blue, def4);} \
  GLAPI void APIENTRY glColor3##ch##v   (const type * v)                 {glColor4##ch(v[0], v[1],  v[2], def4);} \
  GLAPI void APIENTRY glColor4##ch##v   (const type * v)                 {glColor4##ch(v[0], v[1],  v[2], v[3]);}
#define TEXCOORD_WRAPPERS(ch,type,def2,def3,def4) \
  GLAPI void APIENTRY glTexCoord1f (type s)                {glTexCoord4##ch(s,    def2, def3, def4);} \
  GLAPI void APIENTRY glTexCoord2f (type s, type t)        {glTexCoord4##ch(s,    t,    def3, def4);} \
  GLAPI void APIENTRY glTexCoord3f (type s, type t, type r){glTexCoord4##ch(s,    t,    r,    def4);} \
  GLAPI void APIENTRY glTexCoord1fv(const type * v)        {glTexCoord4##ch(v[0], def2, def3, def4);} \
  GLAPI void APIENTRY glTexCoord2fv(const type * v)        {glTexCoord4##ch(v[0], v[1], def3, def4);} \
  GLAPI void APIENTRY glTexCoord3fv(const type * v)        {glTexCoord4##ch(v[0], v[1], v[2], def4);} \
  GLAPI void APIENTRY glTexCoord4fv(const type * v)        {glTexCoord4##ch(v[0], v[1], v[2], v[3]);}

...
GLAPI void APIENTRY glEnableClientState( GLenum cap ); // OpenGL 1.1
GLAPI void APIENTRY glDisableClientState( GLenum cap ); // OpenGL 1.1
...
//GLAPI void APIENTRY glPushClientAttrib( GLbitfield mask ); // OpenGL 1.1
//GLAPI void APIENTRY glPopClientAttrib( void ); // OpenGL 1.1
...
GLAPI void APIENTRY glDepthRangef( GLclampf near_val, GLclampf far_val );
...
GLAPI void APIENTRY glOrthof( GLfloat  left, GLfloat  right, GLfloat  bottom, GLfloat  top, GLfloat  near_val, GLfloat  far_val );
GLAPI void APIENTRY glOrtho ( GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val );
GLAPI void APIENTRY glFrustumf( GLfloat  left, GLfloat  right, GLfloat  bottom, GLfloat  top, GLfloat  near_val, GLfloat  far_val );
...
//GLAPI void APIENTRY glIndexub( GLubyte c ); // OpenGL 1.1
...
//GLAPI void APIENTRY glIndexubv( const GLubyte *c ); // OpenGL 1.1

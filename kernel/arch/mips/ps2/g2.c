...
//---------------------------------------------------------------------------
static uint16_t	g2_max_x=0;		// current resolution max coordinates
static uint16_t	g2_max_y=0;
...
//---------------------------------------------------------------------------
void g2_put_pixel(uint16_t x, uint16_t y)
{
	x += gs_origin_x;
	y += gs_origin_y;
...
//---------------------------------------------------------------------------
void g2_line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
	x0 += gs_origin_x;
	y0 += gs_origin_y;
	x1 += gs_origin_x;
...
//---------------------------------------------------------------------------
void g2_rect(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
	x0 += gs_origin_x;
	y0 += gs_origin_y;
	x1 += gs_origin_x;
...
//---------------------------------------------------------------------------
void g2_fill_rect(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
	x0 += gs_origin_x;
	y0 += gs_origin_y;
	x1 += gs_origin_x;
...
void g2_put_image(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint32_t *data)
{
	...
	//   bytes.
	gs_load_texture(0, 0, w, h, (uint32_t)data, g2_texbuf_addr, g2_max_x+1);
...
//---------------------------------------------------------------------------
uint16_t g2_get_max_x(void)
{
	return(g2_max_x);
}

//---------------------------------------------------------------------------
uint16_t g2_get_max_y(void)
{
	return(g2_max_y);
}

//---------------------------------------------------------------------------
void g2_get_color(uint8_t *r, uint8_t *g, uint8_t *b)
{
	*r = g2_col_r;
	*g = g2_col_g;
	*b = g2_col_b;
...
//---------------------------------------------------------------------------
void g2_get_fill_color(uint8_t *r, uint8_t *g, uint8_t *b)
{
	*r = g2_fill_r;
	*g = g2_fill_g;
	*b = g2_fill_b;
...
//---------------------------------------------------------------------------
void g2_set_color(uint8_t r, uint8_t g, uint8_t b)
{
	g2_col_r = r;
	g2_col_g = g;
	g2_col_b = b;
...
//---------------------------------------------------------------------------
void g2_set_fill_color(uint8_t r, uint8_t g, uint8_t b)
{
	g2_fill_r = r;
	g2_fill_g = g;
	g2_fill_b = b;
